var TOUCH = "stop", TOUCH_X = 0, TOUCH_Y = 0, OFFSET_X = 0, OFFSET_Y = 0, console = console || {
    log : function () {}
};
...
document.body.addEventListener(touchstart, function (e) 
{
    ...
    if ("touchstart" == touchstart) {
        var t = e.changedTouches || e.targetTouches, n = t[0];
...
{
    if ("start" != TOUCH && "move" != TOUCH) {
        return;
    }
    var t = 0, n = 0;
    if ("touchstart" == touchstart) 
    {
        var r = e.changedTouches || e.targetTouches, i = r[0];
        t = Math.abs(i.pageX - TOUCH_X), n = Math.abs(i.pageY - TOUCH_Y) 
    }
    else {
        t = Math.abs(e.clientX - TOUCH_X), n = Math.abs(e.clientY - TOUCH_Y);
    }
    if (t > 5 || n > 5) {
        TOUCH = "move";
    }
...
var get_transform_value = function (e, t) 
{
    ...
    var i = new RegExp(t + "\\(([^\\)]+)\\)", "ig"), s = e.match(i), o = [], u = [];
    if (s && s.length > 0) {
...
transform_css = function () 
{
    ...
    return e.style.cssText = "-webkit-transition:all .1s; -moz-transition:all .1s; -o-transition:all .1s; -ms-transition:all .1s; transition:all .1s;", 
    e.style.webkitTransition ? function (e) 
    {
        return {
            "-webkit-transform" : e 
        }
    }
     : e.style.mozTransition ? function (e) 
    {
        return {
            "-moz-transform" : e 
        }
    }
     : e.style.oTransition ? function (e) 
    {
        return {
            "-o-transform" : e 
        }
    }
     : e.style.msTransition ? function (e) 
    {
        return {
            "-ms-transform" : e 
        }
...
INDEX = function () 
{
    var e = $(".wrapper"), t = 0, n = 0, r = 0, i = document.documentElement.clientHeight, s = document.documentElement.clientWidth, 
    o = e.children("section").length - 1, u = i * o, a = 0, f = e.children("section");
    e.css({
        height : 11 * i + "px" 
    }), f.css({
        height : i + "px" 
    ...
    {
        var t = i, n = s;
        i = document.documentElement.clientHeight, s = document.documentElement.clientWidth, u = i * o, 
        r = - 1 * a * i, c && (i < s ? l.show() : l.hide()), i != t && (e.css({
            height : 11 * i + "px" 
        }), f.css({
            height : i + "px" 
    ...
    var h = function () 
    {
        ...
        }).on(touchmove, function (i) 
        {
            ...
            if ("touchstart" == touchstart) 
            {
                ...
                n = i.clientY - t, e.css(transform_css("translate3d(0," + (r + n) + "px,0)")) ;
            }
        }).on(touchend, function (t) 
        {
            var n = $(this).css("-webkit-transform") || $(this).css("-moz-transform") || $(this).css("-o-transform") || $(this).css("-ms-transform") || $(this).css("transform"), 
            s = parseInt(get_transform_value(n, "translate3d", 1)) || r, o = s - r, f = a;
            if ("start" == TOUCH && o != 0) {
                return;
            }
            if (Math.abs(o) > 80) {
    ...
    p = function (t, n, r) 
    {
        var s = r ? "without_keep" : "keep", o = r ? 0 : 600;
        e.addClass(s).css(transform_css("translate3d(0,-" + n * i + "px,0)")), setTimeout(function () 
        {
            t != n && (d[n] && typeof d[n].init == "function" && d[n].init(), d[t] && typeof d[t].uninit == "function" && d[t].uninit()), 
            e.removeClass(s) 
        }, o), e.attr("pos", n), a = n ;
    },
    d = [];
    d[0] = function () 
    {
        var t = e.children(".sec1"), n = t.find(".petals > .petal"), r = t.find('[removeStyle="Y"]');
        r.each(function () 
        {
        ...
        s = function () 
        {
            r.each(function () 
            {
                var e = parseInt(this.getAttribute("delay")) || 0, t = this;
    ...
    {
        t = t || "1", r = r || "Y";
        var i = n || e.children(".sec" + t), s = i.find('[removeStyle="' + r + '"]'), o = i.find('[pop="' + r + '"]'), 
        u = i.find("[addClass]"), a = i.children(".h_wrp"), f = i.find('[horizontal="drag"]').get(0);
        s.each(function () 
        {
            this.setAttribute("cssText", this.style.cssText) 
        }), o.each(function () 
    ...
    d[1] = v("_desc"), d[2] = v("2"), d[3] = v("3"), d[4] = v("4"), d[5] = v("5"), d[6] = v("5-app"), 
    d[7] = v("5-oper"), d[8] = v("6"), d[9] = v("7"), d[10] = v("8");
    var m = e.find('[horizontal="drag"]'), g = [], y = e.find("ul.tab");
    m.each(function (e) 
    {
        var t = $(this).find("dd");
        g[e] = g[e] || [];
        for (var n = 0; n <= t.length; ++n) {
            0 == n && (g[e][0] = d[e + 2]), g[e][n] = v(n - 1, t.eq(n - 1), "N") ;
        }
    });
    var b = function (e) 
    {
        var t = 0, n = 0, r = 0, i = 0, o = 0, u = $(e).children("dd").length, a = 0;
        $(e).on(touchstart, function (e) 
        {
        ...
        }).on(touchmove, function (e) 
        {
            ...
            if ("touchstart" == touchstart) 
            {
                var i = e.changedTouches || e.targetTouches, s = i[0];
                n = s.pageX - TOUCH_X, r = s.pageY - TOUCH_Y 
            }
            else {
                n = e.clientX - TOUCH_X, r = e.clientY - TOUCH_Y;
            }
            if (1 != o && Math.abs(n) < Math.abs(r)) {
                o = - 1;
                return 
            }
            o = 1, e.stopPropagation(), $(this).css(transform_css("translate3d(" + (t + n) + "px,0,0)")), 
            TOUCH = "move" ;
        }).on(touchend, function (e) 
        {
            var r = this;
            i = Math.abs(t  / s), Math.abs(n) >= 60 ? n > 0 ? i > 0 && --i : n < 0 && i < u && ++i : n == 0 && (i = - 1), 
            w(this, i);
            var o = (new Date).getTime();
            "start" == TOUCH && (a ? o - a <= 300 ? (a = 0, $(this).next().toggle()) : a = o : a = o), 
            TOUCH = "stop" ;
        }) 
    },
    w = function (t, n) 
    {
        ...
        var r = parseInt(t.getAttribute("pos")) || 0, i = parseInt(e.attr("pos")) || 0;
    ...
    var x = $("#loading"), T = $("#loading_text"), N = function () 
    {
        var e = ["image/logo.png"], t = e.length, n = 0, r = function (e) 
        {
            var r = new Image;
            r.onload = function () 
            {
        ...
        var s = 60, o = function () 
        {
            0 >= s ? n  / t > .5 ? u() : alert("加载图片失败，请返回刷新尝试!") : (s -= .5, n == t ? u() : setTimeout(o, 
            500)) 
        },
        u = function () {};
        return function (e) 
...
(function () 
{
    ...
    function s() 
    {
        ...
        {
            appid : "wxaf1d4daa8e0ec0b5", img_url : t, img_width : "150", img_height : "150", link : e, 
            desc : n, title : r 
        },
        function (e) {}) 
    }
    function o() 
    {
        WeixinJSBridge.invoke("shareTimeline", {
            img_url : t, img_width : "150", img_height : "150", link : e, desc : n, title : n 
        },
        function (e) {}) 
    }
    var e = "http://crbrsfadev.crc.com.cn:8080/zhaopin/index.htm", t = "http://crbrsfadev.crc.com.cn:8080/zhaopin/images/crv.png", 
    n = "中国好人才，I want you，华润万家电商招聘开始了，快到家里来！", r = "华润万家电商招聘邀请函";
    typeof WeixinJSBridge == "object" && typeof WeixinJSBridge.invoke == "function" ? i() : document.addEventListener ? document.addEventListener("WeixinJSBridgeReady", 
    i, !1) : document.attachEvent && (document.attachEvent("WeixinJSBridgeReady", i), document.attachEvent("onWeixinJSBridgeReady", 
    i))
})()